...
export default function AddAnnouncement() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Here you would typically send the form data to your backend or state management
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Add Announcement</h1>
              <p className="text-gray-600 mt-1">Owner Dashboard - Add a New Announcement</p>
            </div>
