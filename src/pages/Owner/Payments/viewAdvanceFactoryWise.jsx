      ...
      <div className="flex items-center justify-between mb-6 border-b border-tea-100 dark:border-card-border-dark pb-4">
        <div>
          <h2 className="text-2xl font-heading font-bold text-tea-700 dark:text-tea-300 flex items-center gap-2">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full border-2 border-tea-600 dark:border-tea-500 bg-amber-50 dark:bg-amber-900/20 text-tea-700 dark:text-tea-300 font-semibold text-base">
              Advances Given
            </span>
          </h2>
      ...
      <div className="mb-8">
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Legend />
            <Bar dataKey="amount" fill="#4C8D7E" name="Advances (LKR)" radius={[8, 8, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
