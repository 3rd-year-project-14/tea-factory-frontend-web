...
// // Form component directly embedded in the main file
...
//     // Create a clean data object without the newCategory field
...
//               {company
//                 ? "Edit Fertilizer Company"
//                 : "Add New Fertilizer Company"}
//             </h2>
//             <button
//               onClick={onClose}
...
//       {
//         id: 1,
//         name: "Green Growth Fertilizers",
//         address: "123 Agriculture Lane, Colombo",
//         contactPerson: "Kamal Perera",
//         contactNumber: "0771234567",
//         email: "kamal@greengrowth.lk",
//         categories: ["Organic", "Nitrogen-rich"],
//       },
//       {
//         id: 2,
//         name: "TeaLeaf Nutrients",
//         address: "456 Plantation Road, Kandy",
//         contactPerson: "Nimal Silva",
//         contactNumber: "0762345678",
//         email: "nimal@tealeafnutrients.lk",
//         categories: ["Phosphate", "Potassium"],
//       },
//     ];

//     // Extract all unique categories
//     const allCategories = Array.from(
//       new Set(mockCompanies.flatMap((company) => company.categories))
//     );
...
const API_BASE = "http://localhost:8080/api/fertilizer-companies";
...
const FertilizerCompany = () => {
  ...
  const handleSaveCompany = (companyData) => {
    if (editingCompany) {
      // Update
      fetch(`${API_BASE}/${editingCompany.id}`, {
        method: "PUT",
