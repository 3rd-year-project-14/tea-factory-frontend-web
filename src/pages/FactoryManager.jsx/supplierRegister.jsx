  ...
  return (
    <div className="container max-w-[1440px] mx-auto p-6 bg-[#f8fafc] text-[#1e293b] min-h-screen">
      ...
      <div className="page-header bg-white rounded-xl p-8 mb-6 shadow">
        ...
        <p className="page-description text-base text-[#64748b]">
          Review and manage supplier approval requests
        </p>
      </div>
      {/* Filter Section */}
            ...
            <tbody>
              {filteredSuppliers.map((s) => (
                <tr key={s.id} className="hover:bg-[#f8fafc]">
                  ...
                  {/* <td className="p-4">
                    <div>NIC: {s.nic}</div>
                    <div className="text-[#64748b] text-xs">{s.phone}</div>
                  </td> */}
                  <td className="p-4">{s.location}</td>
                  <td className="p-4">{s.supply}</td>
